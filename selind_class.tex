...
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-1-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-1-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-3-1.pdf}}
\end{column}
\end{columns}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-4-1.pdf}}
\end{frame}

\begin{frame}{Maximum likelihood function}
\phantomsection\label{maximum-likelihood-function-1}
\begin{center}
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-5-1.pdf}
\end{center}
\end{frame}
...
\textbf{2 traits; 100 genotypes; 2 blocks}

\begin{figure}

\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-6-1.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-6-2.pdf}}\end{minipage}%
...
\caption{\label{tbl-multenv}GY and PH evaluated in multenvironmental
trials}

\centering{

\includegraphics[width=0.3\linewidth,height=\textheight,keepaspectratio]{selind_class_files/figure-beamer/tbl-multenv-1.pdf}
...
where \(LogL\) é o ponto de máxima da função de verossimilhança residual
...
\begin{longtable}[t]{lr}
\caption{\label{tab:unnamed-chunk-8}LME4 - g x e}\\
\toprule
 & (Intercept)\\
\midrule
...
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-10-1.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{selind_class_files/figure-beamer/unnamed-chunk-10-2.pdf}}\end{minipage}%
...
(1936) \& Hazel (1943) ; Kempthorne and Nordskog (1959)). We take a deep
look in Factor analysis and ideotype design index (FAI-BLUP)(Rocha,
Machado, and Carneiro 2018) and Bayesian probabilistic selection index
(BPSI)(Chagas et al. 2025).
\end{block}
\end{frame}
...
\phantomsection\label{factor-analysis}
Maize simulated dataset (2 traits * 3 enviroments)

To proceed factor analysis, we should do the pearson correlation between
traits and create matrix correlation.
...
1 -0.30 -0.09  0.11 -0.80 -3.24 1.54
2  0.10 -0.05  0.02 -2.69 -2.24 1.39
3  0.35  0.04 -0.11  0.70 -0.42 1.21
\end{verbatim}
...
\begin{verbatim}
   GY_1  GY_2  GY_3  PH_1  PH_2 PH_3
1 -1.38 -0.40  0.50 -0.42 -1.53 0.81
2  0.46 -0.22  0.07 -1.43 -1.06 0.73
3  1.63  0.19 -0.51  0.37 -0.20 0.63
\end{verbatim}
...
\begin{verbatim}
      GY_1  GY_2  GY_3  PH_1  PH_2  PH_3
GY_1  1.00 -0.05 -0.15  0.10  0.15 -0.03
GY_2 -0.05  1.00  0.04 -0.09  0.23  0.15
GY_3 -0.15  0.04  1.00  0.09 -0.25  0.39
PH_1  0.10 -0.09  0.09  1.00  0.13 -0.26
PH_2  0.15  0.23 -0.25  0.13  1.00 -0.34
PH_3 -0.03  0.15  0.39 -0.26 -0.34  1.00
\end{verbatim}

Correlation near to zero leading to different factors. Representing
correlation among traits Correlações próximas de zero propiciam a
extração de fatores diferentes. Representar as correlações entre os
traits por meio de variáveis latentes (fatores).
\end{frame}

\begin{frame}{Análise de Fatores - Autovalores}
\phantomsection\label{anuxe1lise-de-fatores---autovalores}
...
\begin{frame}[fragile]{Análise de Fatores - Polinômio característico}
\phantomsection\label{anuxe1lise-de-fatores---polinuxf4mio-caracteruxedstico}
...
\begin{frame}{Análise de Fatores - Escores fatoriais}
\phantomsection\label{anuxe1lise-de-fatores---escores-fatoriais}
...
\begin{frame}{Extração dos fatores}
...
\begin{frame}{Análise de Fatores- Cargas fatoriais}
\phantomsection\label{anuxe1lise-de-fatores--cargas-fatoriais}
...
where \(i\) represents the rank from probability of superior performance
for each genotype evaluated and \(m\) the amount of traits.
...
{\centering \includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio]{misc/images/experimental design.pdf}
...
\caption{\label{fig-acg}Grain Appearance}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{misc/images/PlotsDen.pdf}
...
{\centering \includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{misc/images/PlotsMargs.pdf}
...
{\centering \includegraphics[width=0.3\linewidth,height=\textheight,keepaspectratio]{misc/images/PlotsConds.pdf}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{misc/images/PlotsPairs.pdf}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{misc/images/PSIplot.pdf}
